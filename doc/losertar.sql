...
INSERT INTO `sys_dict` (`dict_id`, `dict_value`, `dict_name`, `dict_type`, `dict_remarks`, `dict_c_name`, `dict_css_style`, `dict_sort`, `del`, `create_time`, `create_user_code`, `create_user_name`, `update_time`, `update_user_code`, `update_user_name`) VALUES
	('1006ab08d7421000', '1', '是', 'com_if', '通用类型，是否', 'IF_1', '', 1, '0', '2023-09-22 07:16:36', '15087010221', '', NULL, '', ''),
	('1006ab3cd1021000', '0', '否', 'com_if', '通用类型，是否', 'IF_0', '', 2, '0', '2023-09-22 07:17:29', '15087010221', '', '2023-09-22 07:17:48', '15087010221', NULL);
...
-- 正在导出表  loserstar.sys_file 的数据：~2 rows (大约)
...
INSERT INTO `sys_file` (`id`, `name`, `path`, `upload_time`, `sort`, `del`, `create_time`, `create_user_code`, `create_user_name`, `update_time`, `update_user_code`, `update_user_name`, `suffix`, `from_id`, `from_table`) VALUES
	('103c8632ad421000', 'C10941_B150M_PLUS_UM_WEB.pdf', '/disk1/loserStar_Jfinal/loserstar.sys_user/15087010221/15087010221.pdf', '2023-11-03 03:13:38', 1698981217974, '1', '2023-11-03 03:13:38', '15087010221', NULL, NULL, NULL, NULL, '.pdf', '15087010221', 'loserstar.sys_user'),
	('103c875a2f821000', '2022年108玉溪品牌文化节活动策划、执行项目执行变更申请紧急会签表单.pdf', '/disk1/loserStar_Jfinal/loserstar.sys_user/15087010221/15087010221.pdf', '2023-11-03 03:18:41', 1698981520575, '0', '2023-11-03 03:18:41', '15087010221', NULL, NULL, NULL, NULL, '.pdf', '15087010221', 'loserstar.sys_user'),
	('103c87641a021000', '2022å_¡æ_©ç½_æ_°é_«.pdf', '/disk1/loserStar_Jfinal/loserstar.sys_user/15087010221/15087010221.pdf', '2023-11-03 03:18:51', 1698981530728, '0', '2023-11-03 03:18:51', '15087010221', NULL, NULL, NULL, NULL, '.pdf', '15087010221', 'loserstar.sys_user');
...
CREATE TABLE IF NOT EXISTS `sys_user` (
  ...
  `update_user_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人编号',
  `update_user_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人姓名',
  `lock_begin_date` timestamp NULL DEFAULT NULL COMMENT '密码输入次数过多时被锁定的时间记录',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户表';

-- 正在导出表  loserstar.sys_user 的数据：~3 rows (大约)
DELETE FROM `sys_user`;
INSERT INTO `sys_user` (`id`, `user_name`, `password`, `pwd_err_count`, `del`, `create_time`, `create_user_code`, `create_user_name`, `update_time`, `update_user_code`, `update_user_name`, `lock_begin_date`) VALUES
	('15087010221', '老罗手机号', '123', 0, '0', NULL, NULL, NULL, '2023-11-01 09:25:05', '15087010221', NULL, NULL),
	('loserStar', '老罗', 'loserStar', 0, '0', '2023-11-01 09:23:26', '15087010221', NULL, '2023-11-01 09:23:38', '15087010221', NULL, '2024-12-26 10:53:23'),
	('loserStar2', '老罗2', 'loserStar2', 1, '0', '2023-11-01 09:25:22', '15087010221', NULL, NULL, NULL, NULL, NULL);

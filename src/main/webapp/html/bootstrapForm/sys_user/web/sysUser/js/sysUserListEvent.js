...
listPageEvent.queryList = function () {
    //构建查询条件
    var queryObj = {};
    queryObj.id = $("#id").val();//主键id，用作账号名
    queryObj.user_name = $("#user_name").val();//用户名
    queryObj.password = $("#password").val();//密码
    queryObj.pwd_err_count = $("#pwd_err_count").val();//密码输入错误次数
    ...
    queryObj.lock_begin_date = $("#lock_begin_date").val();//密码输入次数过多时被锁定的时间记录

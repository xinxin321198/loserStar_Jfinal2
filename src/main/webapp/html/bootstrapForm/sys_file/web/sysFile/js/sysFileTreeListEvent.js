...
listPageEvent.queryList = function () {
    ...
    sysFileAction.getListData(queryObj, function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            text += "                            <button id=\""+ tmp.id + "_delBtn\" type=\"button\" class=\"btn btn-danger\" onclick=\"sysFileListEvent.del('tmp.id')\">删除</button>";
            text += "                            </div>";
            ...
            text += "                            <button id=\""+ tmp.id + "_delBtn\" type=\"button\" class=\"btn btn-danger btn-app\" onclick=\"sysFileListEvent.del('tmp.id')\"><i class=\"fa fa-trash\"></i>删除</button>";
            text += "                               <div class=\"btn-group\">";
...
listPageEvent.collapseAll = function () {
    $("#sys_file_table").treetable("collapseAll");
}
/**
 * 全部展开
 */
listPageEvent.expandAll = function () {
    $("#sys_file_table").treetable("expandAll");
}
...
listPageEvent.addSubNode = function () {
    var selectedList = $("#sys_file_table tr.selected");

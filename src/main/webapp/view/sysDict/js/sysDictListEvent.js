...
listPageEvent.queryPageList = function () {
    //构建查询条件
    var queryObj = {};
    queryObj.dict_id = $("#dict_id").val();
    queryObj.dict_value = $("#dict_value").val();
    queryObj.dict_name = $("#dict_name").val();
    queryObj.dict_type = $("#dict_type").val();
    queryObj.dict_remarks = $("#dict_remarks").val();
    queryObj.dict_c_name = $("#dict_c_name").val();
    queryObj.dict_css_style = $("#dict_css_style").val();
    queryObj.dict_sort = $("#dict_sort").val();
    ...
    sysDictAction.getPage(queryObj, function (data) {
        console.log(data);

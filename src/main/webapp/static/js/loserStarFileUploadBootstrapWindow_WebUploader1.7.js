...
loserStarFileUploadBootstrapWindow_WebUploader.prototype = {
    ...
    open: function (url, formData) {
        ...
        $("#" + self.flagId + "_FileWindow").on("shown.bs.modal", function (e) {
            ...
            // self.uploader.off("uploadStart");//绑定前要先去掉事件，否则会重复
            ...
            // self.uploader.off("uploadBeforeSend");//绑定前要先去掉事件，否则会重复
            ...
            // self.uploader.off("uploadAccept");//绑定前要先去掉事件，否则会重复
            ...
            //上传过程中触发，携带上传进度。
            // self.uploader.off("uploadProgress");//绑定前要先去掉事件，否则会重复
            ...
            //当文件上传出错时触发。
            // self.uploader.off("uploadError");//绑定前要先去掉事件，否则会重复
            ...
            //当文件上传成功时触发。
            // self.uploader.off("uploadSuccess");//绑定前要先去掉事件，否则会重复
            ...
            //不管成功或者失败，文件上传完成时触发。
            // self.uploader.off("uploadComplete");//绑定前要先去掉事件，否则会重复
             ...
             */
            // self.uploader.off("type");//绑定前要先去掉事件，否则会重复

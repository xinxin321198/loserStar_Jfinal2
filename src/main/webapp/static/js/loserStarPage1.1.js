...
loserStarPage.prototype = {
    ...
    renderHtml: function () {
        ...
        text += "<nav aria-label=\"...\">";
        text += "                        <ul class=\"pager\">";
        text += "                            <li>数据共<label id=\"" + tmp.pageId + "_totalRow\"></label>条，每页<label id=\"" + tmp.pageId + "_pageSize\"></label>条，共<label id=\"" + tmp.pageId + "_totalPage\"></label>页，当前第<input type=\"number\" name=\"\" id=\"" + tmp.pageId + "_pageNumber\" class=\"form-control\" style=\"display:inline-block;width: 75px;\">页</li>";

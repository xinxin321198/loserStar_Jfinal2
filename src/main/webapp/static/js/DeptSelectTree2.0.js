 ...
 * @param url 取数的url,返回vresult结构数据 SELECT '12530401' AS ORGEH_UP,ORGEH,ORGTX FROM ERP_DEP_VIEW UNION ALL SELECT ORGEH_UP,ORGEH,ORGTX FROM ERP_KS_VIEW
 ...
 */
var DeptSelectTree = function (buttonSelector, treeGridSelector, url, treeGridReadyCallback, selectType, selectedEventCallBck) {
 ...
 * 初始化数据以及各组件
 */
DeptSelectTree.prototype = {
    constructor: DeptSelectTree,
    init: function () {
     ...
     */
    setSelectedDeptStrs: function (deptIds) {
        //默认选中当前查询的值
